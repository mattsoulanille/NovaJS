...
describe("novaParse", function() {
	...
	debugger;
	expect(np.ids.resources.shïp["nova:128"].pictID).to.equal(5000);
	expect(np.ids.resources.shïp["nova:129"].pictID).to.equal(5000);
	expect(np.ids.resources.shïp["nova:130"].pictID).to.equal(5002);
