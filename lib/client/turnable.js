...
var turnable = (superclass) => class extends superclass {
	...
	this.properties.physics.turnRate = this.meta.physics.turnRate;
    }

    _getTurnRate() {
	return this.properties.physics.turnRate;
    }
    ...
    set turnRate(v) {
	throw new Error("Can't set turnRate. Set properties.physics.turnRate instead");
    }
