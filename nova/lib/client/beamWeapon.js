...
*/
    ...
    buildConvexHulls() {
	var length = this.meta.beamAnimation.length;
	var halfWidth = this.meta.beamAnimation.width / 2;
	...
	// is at most this.meta.beamAnimation.length

	var scaleFactor =
	    Math.sqrt(beamVector[0] ** 2 + beamVector[1] ** 2)
	    / this.meta.beamAnimation.length;
...
//	this.graphics.position.y = -1 * start[1];
	...
	this.graphics.clear();
	this.graphics.lineStyle(this.meta.beamAnimation.width+1, this.meta.beamAnimation.beamColor);
	...
	let offset = this.meta.beamAnimation.width / 2 + 1;
	this.graphics.moveTo(orthogonal[0] * offset, orthogonal[1] * offset);
	// Corona has width 1
	this.graphics.lineStyle(1, this.meta.beamAnimation.coronaColor);
