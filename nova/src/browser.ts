...
import { multiplayer } from "novajs/nova_ecs/plugins/multiplayer_plugin";
import { World } from "novajs/nova_ecs/world";
...
async function startGame() {
    ...
    const worldContainer = world.resources.get(PixiContainer);
    if (!worldContainer) {
