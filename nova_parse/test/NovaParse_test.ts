...
import { WEAP_SPEED_FACTOR } from "nova_parse/src/parsers/WeaponParse";
import * as path from "path";
import { PNG } from "pngjs";
import { getDefaultExitPoints } from "../../nova_data_interface/Animation";
...
import { getDefaultStatusBarColors, getDefaultStatusBarDataAreas } from "../../nova_data_interface/StatusBarData";
...
describe("NovaParse", function() {
    ...
    it("Should parse PictImage", async function() {
        ...
        const statusBarPath = runfiles.resolve("novajs/nova_parse/test/resource_parsers/files/picts/statusBar.png");
    ...
    it("Should parse SpriteSheetImage", async function() {
        ...
        const shuttlePath = runfiles.resolve("novajs/nova_parse/test/testSpriteSheetImage.png");
    ...
    it("Should parse SpriteSheetFrames", async function() {
        ...
        const frames1116Path = runfiles.resolve("novajs/nova_parse/test/zephyrFrames.json");
        ...
        const frames1000Path =
            runfiles.resolve("novajs/nova_parse/test/testSpriteSheetFrames.json");
    ...
    it("Should parse SpriteSheet", async function() {
        ...
        const sheet1000Path =
            runfiles.resolve("novajs/nova_parse/test/testSpriteSheet.json");
