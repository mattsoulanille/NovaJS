...
describe("RledResource", function() {
    ...
    beforeEach(async function() {
        ...
        starbridgePNG = await getPNG(runfiles.resolve(
            "novajs/nova_parse/test/resource_parsers/files/rleds/starbridge.png"));
        starbridgeMask = await getPNG(runfiles.resolve(
            "novajs/nova_parse/test/resource_parsers/files/rleds/starbridge_mask.png"));
        leviathanPNG = await getPNG(runfiles.resolve(
            "novajs/nova_parse/test/resource_parsers/files/rleds/leviathan.png"));
        leviathanMask = await getPNG(runfiles.resolve(
            "novajs/nova_parse/test/resource_parsers/files/rleds/leviathan_mask.png"));

        const dataPath = runfiles.resolve("novajs/nova_parse/test/resource_parsers/files/rled.ndat");
