...
import { AnimationComponent, SimulationGameDataResource } from '../nova_plugin/core/index.js';
import { BeamDataComponent } from "../nova_plugin/combat/index.js";
import {
    SourceComponent, CloakActiveComponent, CloakScannerComponent, DisabledComponent,
    FoldStateComponent, foldRatePerSecond, moveToward, IonizationColorComponent,
    IsIonizedComponent, ShipComponent, WeaponsStateComponent,
} from '../nova_plugin/ship/index.js';
import { JumpComponent } from "../nova_plugin/travel/index.js";
