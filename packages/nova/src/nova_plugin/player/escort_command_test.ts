...
import { ReturnWhenTargetRemovedComponent, startReturnHome } from '../escorts/index.js';
...
import { styleForTarget } from '../combat/index.js';
...
import { DEFEND_RADIUS, inFrontQuadrant } from '../escorts/index.js';
