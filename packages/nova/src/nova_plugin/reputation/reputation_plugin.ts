...
import { armorFullyRestored, DamagedEvent, DeathEvent, ZeroArmorEvent } from '../ship/index.js';
...
import { revokeRanksForCrime, suppressAggressionGovts } from '../ncb/index.js';
