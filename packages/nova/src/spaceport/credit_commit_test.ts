...
import {
    CargoComponent, makeShip, OutfitsStateComponent, ShipComponent, ShipDataComponent,
...
import { CreditsComponent, PlayerEscortComponent } from '../nova_plugin/player/index.js';
