...
/**
 * The one-time fee to hire an escort — see escort_fees.ts, which also holds
 * the DAILY wage that follows it, so the two cannot drift apart. Re-exported
 * here because this dialog is where the fee is quoted.
 */
