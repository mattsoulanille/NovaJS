 ...
 * (four systems, five stellars, three ships, six weapons, twelve outfits,
 * two governments, NPC tables, missions, ranks, a default pilot, and the
 * pictures the display asks for; see universe.ts there for the whole
 ...
 * mission computer), an uninhabited landable moon, a linked hypergate
 * pair (Kestrel Gate / Vael Gate), a station that needs a legal record
 * of 20 with the raiders, NPC traffic in every system (traders and
 * patrol in Thessaly; raiders and a raider fleet in Kestrel), a
 * missile with ammo and a point defence to shoot it down, a beam, a
 * turret, a fighter bay on the Heron Warden, a cloak sold only at the
 * secret station, a mission-computer job whose OnAccept sets b100, a
 * bar job and a bounty.
 */
