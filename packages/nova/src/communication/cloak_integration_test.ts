...
import {
    CLOAK_OFF_SOUND, CLOAK_ON_SOUND, CloakActiveComponent, CloakComponent, DamagedEvent,
    ShieldComponent, makeShip,
} from '../nova_plugin/ship/index.js';
import { PlayerSoundEvent } from "../nova_plugin/core/index.js";
