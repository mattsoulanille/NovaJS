...
[Here's a running example](http://54.208.57.194) (works in modern browsers).
...
## Running the Tests
Haha. Wouldn't it be nice if I had written tests? This is definitely something that needs to be addressed.
